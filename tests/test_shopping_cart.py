...
def test_go_to_inventory_page_via_hamburger_menu(logged_in_page: Page):
    page = logged_in_page
    inventory= InventoryPage(page)
    inventory.open_shopping_cart_page()
...
def test_go_to_about_page_via_hamburger_menu(logged_in_page: Page):
    page = logged_in_page
    inventory = InventoryPage(page)
    inventory.hamburger_about_page()
    expect(page).to_have_url('https://saucelabs.com/')

def test_logout_via_hamburger_menu(logged_in_page: Page):
    page = logged_in_page
    inventory = InventoryPage(page)
